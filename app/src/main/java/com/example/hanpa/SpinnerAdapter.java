...
public class SpinnerAdapter extends ArrayAdapter<String> {
    ...
    public SpinnerAdapter(@NonNull Context context, String[] names, int[] images) {
        super(context, R.layout.spinner_normal);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.spinner_normal, parent, false);
